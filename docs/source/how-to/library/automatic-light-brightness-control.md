...
Adaptive Areas focuses on **when** lights should turn on or off, not **how bright** they should be.
...
If you want automatic brightness control, you’ll need to pair Adaptive Areas with another integration. A popular choice is [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting), which can smoothly adjust light levels throughout the day.

!!! tip
    Adaptive Lighting includes a **Sleep Mode** switch, which pairs perfectly with Adaptive Areas’ **Sleep state**.
...
This way, Adaptive Areas handles the logic of when to turn lights on/off, while Adaptive Lighting decides how bright they should be.
...
Adaptive Areas doesn’t reinvent brightness control — it lets specialized tools do what they do best.
Pick your favorite brightness integration, connect it with Adaptive Areas states, and enjoy lighting that’s automatic, adaptive, and tailored to your needs.
