...
from custom_components.adaptive_areas.const import (
    ...
    AdaptiveAreasFeatureInfoBLETrackers,
...
class AreaBLETrackerBinarySensor(AdaptiveEntity, BinarySensorEntity):
    """BLE Tracker monitoring sensor for the area."""

    feature_info = AdaptiveAreasFeatureInfoBLETrackers()
    _sensors: list[str]
    ...
    def __init__(self, area: AdaptiveArea) -> None:
        ...
        self._sensors = self.area.feature_config(AdaptiveAreasFeatures.BLE_TRACKER).get(
            CONF_BLE_TRACKER_ENTITIES, []
        )
