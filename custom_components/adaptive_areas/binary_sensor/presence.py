"""Main presence tracking entity for Adaptive Areas."""
...
from custom_components.adaptive_areas.const import (
    ...
    CalculationMode,
    AdaptiveAreasEvents,
    AdaptiveAreasFeatureInfo,
    AdaptiveAreasFeatureInfoPresenceTracking,
)

_LOGGER = logging.getLogger(__name__)


class AreaStateTrackerEntity(BinaryAdaptiveEntity):
    ...
    def __init__(self, area: AdaptiveArea) -> None:
        ...
        self.area: AdaptiveArea | AdaptiveMetaArea = area
...
class AreaStateBinarySensor(AreaStateTrackerEntity, BinarySensorEntity):
    ...
    feature_info: AdaptiveAreasFeatureInfo = AdaptiveAreasFeatureInfoPresenceTracking()
...
class MetaAreaStateBinarySensor(AreaStateBinarySensor):
    ...
    area: AdaptiveMetaArea
    ignore_non_state_change: bool = False

    def __init__(self, area: AdaptiveMetaArea) -> None:
        """Initialize the area presence binary sensor."""
    ...
    def _get_secondary_states(self) -> list[AreaStates]:
        ...
        for area_slug in child_areas:
            area_entity_id: str = (
                f"{BINARY_SENSOR_DOMAIN}.adaptive_areas_presence_tracking_{area_slug}_area_state"
            )
