...
_ENTITY_REFERENCE_CATEGORIES = {
    ...
    CONF_ENVIRONMENT_OUTDOOR_TEMPERATURE: "environment",
    CONF_ENVIRONMENT_WINDOWS: "environment",
    CONF_ENVIRONMENT_VENTILATION_FANS: "environment",
    CONF_ENVIRONMENT_CIRCULATION_FANS: "environment",
    CONF_ENVIRONMENT_DISABLED_FANS: "environment",
}
