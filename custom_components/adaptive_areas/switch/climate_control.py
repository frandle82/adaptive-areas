...
from custom_components.adaptive_areas.const import (
    ...
    AreaStates,
    AdaptiveAreasEvents,
    AdaptiveAreasFeatureInfoClimateControl,
...
class ClimateControlSwitch(SwitchBase):
    ...
    feature_info = AdaptiveAreasFeatureInfoClimateControl()
    ...
    def __init__(self, area: AdaptiveArea) -> None:
        ...
        feature_config = self.area.feature_config(AdaptiveAreasFeatures.CLIMATE_CONTROL)
