...
from custom_components.adaptive_areas.const import ONE_MINUTE


class SwitchBase(AdaptiveEntity, SwitchEntity):
    """The base class for all the switches."""

    _attr_state: str

    def __init__(self, area: AdaptiveArea, translation_key: str | None = None) -> None:
...
class ResettableSwitchBase(SwitchBase):
    ...
    def __init__(self, area: AdaptiveArea, timeout: int = 0) -> None:
