"""Platform file for Adaptive Area's media_player entities."""
...
from custom_components.adaptive_areas.const import (
    ...
    META_AREA_GLOBAL,
    MODULE_DATA,
    AdaptiveAreasFeatureInfoMediaPlayerGroups,
)
from custom_components.adaptive_areas.helpers.area import get_area_from_config_entry
from custom_components.adaptive_areas.media_player.area_aware_media_player import (
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    if MEDIA_PLAYER_DOMAIN in area.adaptive_entities:
        cleanup_removed_entries(
            area.hass, entities_to_add, area.adaptive_entities[MEDIA_PLAYER_DOMAIN]
        )
...
class AreaMediaPlayerGroup(AdaptiveEntity, MediaPlayerGroup):
    """Media player group."""

    feature_info = AdaptiveAreasFeatureInfoMediaPlayerGroups()
